    ...
    <section className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
          ...
          <div>
            <p className="font-semibold tracking-wide text-gray-800">Payment</p>
            <ul className="mt-2 space-y-2">
              <li>
                <a
                  href="/"
      ...
      <div className="flex flex-col justify-between items-center pt-5 pb-10 border-t sm:flex-row">
